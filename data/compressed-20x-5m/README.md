# Compressed-20X-5M Dataset

## 📊 Dataset Overview

**Dataset Name:** `compressed-20x-5m`  
**Created:** November 18, 2025  
**Source:** `data/converted3` (Real workload data from system exports)  
...
- `compressed-20x-5m_reduction_summary.json` - Detailed reduction statistics
...
- **Duration Range:** 3 - 24 timeslices
- **VF Requirements:** Preserved where applicable
- **MANO Requirements:** Preserved for relevant jobs

### Temporal Characteristics
- **Time Range:** 0 - 72 timeslices (compressed from 0 - 1,439)
- **Compression Method:** Linear scaling (divide by 20)
- **Timeline Estimate:** ~18.0 hours (72 × 15-min intervals)
...
- **Complexity:** Medium (72 × 209 = 15,048 decision variables for X-mode)
...
- Timeline duration (1,439 → 72 timeslices, 95.0% reduction)
...
- **Source:** `data/converted3` - Full real workload dataset
