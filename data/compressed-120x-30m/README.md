# Compressed-120X-30M Dataset

## 📊 Dataset Overview

**Dataset Name:** `compressed-120x-30m`  
...
- `compressed-120x-30m_reduction_summary.json` - Detailed reduction statistics
...
- **Time Range:** 0 - 12 timeslices (compressed from 0 - 1,439)
- **Compression Method:** Linear scaling (divide by 120)
- **Timeline Estimate:** ~3.0 hours (12 × 15-min intervals)
...
- **Complexity:** Low (12 × 209 = 2,508 decision variables for X-mode)
...
python3 enhanced_dataset_reducer.py data/converted3 \
  --target data/compressed-120x-30m \
  --jobs 1.000 \
  --capacity 1.0 \
  --time 120 \
...
- Timeline duration (1,439 → 12 timeslices, 99.2% reduction)
