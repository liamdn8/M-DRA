# Compressed-60X-15M Dataset

## 📊 Dataset Overview

**Dataset Name:** `compressed-60x-15m`  
...
- `compressed-60x-15m_reduction_summary.json` - Detailed reduction statistics
...
- **Complexity:** Low (24 × 209 = 5,016 decision variables for X-mode)
...
python3 enhanced_dataset_reducer.py data/converted3 \
  --target data/compressed-60x-15m \
  --jobs 1.000 \
  --capacity 1.0 \
  --time 60 \
...
- Timeline duration (1,439 → 24 timeslices, 98.3% reduction)
