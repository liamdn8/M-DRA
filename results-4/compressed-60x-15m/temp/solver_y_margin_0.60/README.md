...
python3 main.py \
  ...
  --margin 0.6 \
  --out results-4/compressed-60x-15m/temp/solver_y_margin_0.60
```
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_y_margin_0.60`
