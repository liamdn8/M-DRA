...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-4/compressed-60x-15m/temp/solver_x_margin_0.50
```
...
- Job 27 assigned to Cluster 1 (default: 0), relocation cost: 6
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_x_margin_0.50`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 139 job relocations were necessary to satisfy constraints
