...
### Performance Metrics
- **Avg Time per Job:** 13.305 seconds
...
python3 main.py \
  ...
  --margin 0.85 \
  --out results-4/compressed-60x-15m/temp/solver_y_margin_0.85
```
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_y_margin_0.85`
