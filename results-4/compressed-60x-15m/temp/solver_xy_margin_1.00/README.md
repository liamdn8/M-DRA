...
### Performance Metrics
- **Avg Time per Job:** 0.171 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results-4/compressed-60x-15m/temp/solver_xy_margin_1.00
```
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_xy_margin_1.00`
