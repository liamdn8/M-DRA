...
python3 main.py \
  ...
  --margin 0.6 \
  --out results-4/compressed-60x-15m/temp/solver_x_margin_0.60
```
...
- Job 1 assigned to Cluster 3 (default: 0), relocation cost: 2
- Job 2 assigned to Cluster 3 (default: 0), relocation cost: 2
...
- Job 11 assigned to Cluster 3 (default: 0), relocation cost: 3
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_x_margin_0.60`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 65 job relocations were necessary to satisfy constraints
