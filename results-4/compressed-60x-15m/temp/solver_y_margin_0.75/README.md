...
| **Optimal Value** | 20.000000000000007 |
...
### Performance Metrics
- **Avg Time per Job:** 14.036 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-4/compressed-60x-15m/temp/solver_y_margin_0.75
```
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_y_margin_0.75`
