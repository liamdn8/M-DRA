...
- **Total Relocations:** 47.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 7
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.084 seconds
- **Solution Quality:** 47 relocations needed
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results-4/compressed-60x-15m/temp/solver_x_margin_0.65
```
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_x_margin_0.65`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 47 job relocations were necessary to satisfy constraints
