...
| **Optimal Value** | 32.000000000000014 |
...
### Performance Metrics
- **Avg Time per Job:** 0.172 seconds
...
python3 main.py \
  ...
  --margin 0.7 \
  --out results-4/compressed-60x-15m/temp/solver_xy_margin_0.70
```
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_xy_margin_0.70`
