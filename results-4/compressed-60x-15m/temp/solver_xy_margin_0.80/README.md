...
python3 main.py \
  ...
  --margin 0.8 \
  --out results-4/compressed-60x-15m/temp/solver_xy_margin_0.80
```
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_xy_margin_0.80`
