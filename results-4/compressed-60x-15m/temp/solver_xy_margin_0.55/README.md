...
| **Optimal Value** | 45.00000000000001 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 45.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 1
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.176 seconds
- **Solution Quality:** 45 relocations needed
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-4/compressed-60x-15m/temp/solver_xy_margin_0.55
```
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_xy_margin_0.55`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 45 job relocations were necessary to satisfy constraints
