...
### Performance Metrics
- **Avg Time per Job:** 0.177 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-4/compressed-60x-15m/temp/solver_xy_margin_0.75
```
...
- **Output Directory:** `results-4/compressed-60x-15m/temp/solver_xy_margin_0.75`
