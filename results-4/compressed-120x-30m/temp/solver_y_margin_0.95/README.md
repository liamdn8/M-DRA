...
### Performance Metrics
- **Avg Time per Job:** 8.170 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results-4/compressed-120x-30m/temp/solver_y_margin_0.95
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_y_margin_0.95`
