...
- **Total Relocations:** 143.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 23
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.047 seconds
- **Solution Quality:** 143 relocations needed
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-4/compressed-120x-30m/temp/solver_x_margin_0.55
```
...
- Job 16 assigned to Cluster 3 (default: 0), relocation cost: 5
- Job 17 assigned to Cluster 0 (default: 0), relocation cost: 0
- Job 18 assigned to Cluster 1 (default: 0), relocation cost: 6
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_x_margin_0.55`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 143 job relocations were necessary to satisfy constraints
