...
| **Optimal Value** | 34.00000000000004 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 34.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 2
...
- **Solution Quality:** 34 relocations needed
...
python3 main.py \
  ...
  --margin 0.6 \
  --out results-4/compressed-120x-30m/temp/solver_xy_margin_0.60
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_xy_margin_0.60`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 34 job relocations were necessary to satisfy constraints
