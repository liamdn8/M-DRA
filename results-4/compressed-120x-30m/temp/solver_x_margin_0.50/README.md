...
- **Total Relocations:** 168.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 27
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.046 seconds
- **Solution Quality:** 168 relocations needed
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-4/compressed-120x-30m/temp/solver_x_margin_0.50
```
...
- Job 16 assigned to Cluster 1 (default: 0), relocation cost: 5
- Job 17 assigned to Cluster 0 (default: 0), relocation cost: 0
- Job 18 assigned to Cluster 3 (default: 0), relocation cost: 6
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_x_margin_0.50`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 168 job relocations were necessary to satisfy constraints
