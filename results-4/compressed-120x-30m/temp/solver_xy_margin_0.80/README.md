...
### Performance Metrics
- **Avg Time per Job:** 0.095 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results-4/compressed-120x-30m/temp/solver_xy_margin_0.80
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_xy_margin_0.80`
