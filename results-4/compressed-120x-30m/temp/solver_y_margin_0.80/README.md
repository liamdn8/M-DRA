...
### Performance Metrics
- **Avg Time per Job:** 7.823 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results-4/compressed-120x-30m/temp/solver_y_margin_0.80
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_y_margin_0.80`
