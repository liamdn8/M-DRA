...
- **Solution Quality:** 96 relocations needed
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results-4/compressed-120x-30m/temp/solver_x_margin_0.65
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_x_margin_0.65`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 96 job relocations were necessary to satisfy constraints
