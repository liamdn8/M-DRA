...
- **Total Relocations:** 50.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 5
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.100 seconds
- **Solution Quality:** 50 relocations needed
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-4/compressed-120x-30m/temp/solver_xy_margin_0.55
```
...
- Job 7 assigned to Cluster 1 (default: 0), relocation cost: 2
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_xy_margin_0.55`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 50 job relocations were necessary to satisfy constraints
