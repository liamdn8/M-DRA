...
| **Optimal Value** | 40.00000000000008 |
...
### Performance Metrics
- **Avg Time per Job:** 8.258 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-4/compressed-120x-30m/temp/solver_y_margin_0.75
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_y_margin_0.75`
