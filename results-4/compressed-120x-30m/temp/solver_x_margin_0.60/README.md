...
python3 main.py \
  ...
  --margin 0.6 \
  --out results-4/compressed-120x-30m/temp/solver_x_margin_0.60
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_x_margin_0.60`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 122 job relocations were necessary to satisfy constraints
