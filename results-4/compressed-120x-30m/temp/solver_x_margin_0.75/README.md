...
| **Optimal Value** | 54.99999999999999 |
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-4/compressed-120x-30m/temp/solver_x_margin_0.75
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_x_margin_0.75`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 55 job relocations were necessary to satisfy constraints
