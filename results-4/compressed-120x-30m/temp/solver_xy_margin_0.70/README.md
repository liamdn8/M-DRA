...
| **Optimal Value** | 32.00000000000013 |
...
python3 main.py \
  ...
  --margin 0.7 \
  --out results-4/compressed-120x-30m/temp/solver_xy_margin_0.70
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_xy_margin_0.70`
