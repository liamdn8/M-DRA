...
| **Optimal Value** | 24.000000000000007 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 24.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 5
...
- **Solution Quality:** 24 relocations needed
...
python3 main.py \
  ...
  --margin 0.85 \
  --out results-4/compressed-120x-30m/temp/solver_x_margin_0.85
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_x_margin_0.85`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 24 job relocations were necessary to satisfy constraints
