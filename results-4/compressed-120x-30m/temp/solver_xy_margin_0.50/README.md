...
| **Optimal Value** | 62.000000000000064 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 62.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 3
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.094 seconds
- **Solution Quality:** 62 relocations needed
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-4/compressed-120x-30m/temp/solver_xy_margin_0.50
```
...
- **Output Directory:** `results-4/compressed-120x-30m/temp/solver_xy_margin_0.50`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 62 job relocations were necessary to satisfy constraints
