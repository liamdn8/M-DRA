...
| **Optimal Value** | 20.000000000000004 |
...
### Performance Metrics
- **Avg Time per Job:** 42.513 seconds
...
python3 main.py \
  ...
  --margin 0.85 \
  --out results-4/compressed-20x-5m/temp/solver_y_margin_0.85
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_y_margin_0.85`
