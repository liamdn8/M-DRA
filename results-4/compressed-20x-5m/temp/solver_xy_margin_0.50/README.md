...
### Performance Metrics
- **Avg Time per Job:** 0.595 seconds
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-4/compressed-20x-5m/temp/solver_xy_margin_0.50
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_xy_margin_0.50`
