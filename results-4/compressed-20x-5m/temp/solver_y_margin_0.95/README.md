...
### Performance Metrics
- **Avg Time per Job:** 39.793 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results-4/compressed-20x-5m/temp/solver_y_margin_0.95
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_y_margin_0.95`
