...
| **Status** | ✅ optimal |
| **Return Code** | 0 |
| **Execution Time** | 116.31 seconds |
| **Optimal Value** | 48.99999999999999 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 49.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 3
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.557 seconds
- **Solution Quality:** 49 relocations needed
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-4/compressed-20x-5m/temp/solver_xy_margin_0.55
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_xy_margin_0.55`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 49 job relocations were necessary to satisfy constraints
