...
| **Status** | ✅ optimal |
| **Return Code** | 0 |
| **Execution Time** | 112.56 seconds |
| **Optimal Value** | 19.999999999999996 |
...
### Performance Metrics
- **Avg Time per Job:** 0.539 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results-4/compressed-20x-5m/temp/solver_xy_margin_0.80
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_xy_margin_0.80`
