...
python3 main.py \
  ...
  --margin 0.9 \
  --out results-4/compressed-20x-5m/temp/solver_xy_margin_0.90
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_xy_margin_0.90`
