...
| **Status** | ✅ optimal |
| **Return Code** | 0 |
| **Execution Time** | 129.06 seconds |
| **Optimal Value** | 26.0 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 26.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 3
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.618 seconds
- **Solution Quality:** 26 relocations needed
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-4/compressed-20x-5m/temp/solver_xy_margin_0.75
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_xy_margin_0.75`
