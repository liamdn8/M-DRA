...
| **Return Code** | 0 |
| **Execution Time** | 190.42 seconds |
| **Optimal Value** | 46.00000000000021 |
...
python3 main.py \
  ...
  --margin 0.6 \
  --out results-4/compressed-20x-5m/temp/solver_xy_margin_0.60
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_xy_margin_0.60`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 46 job relocations were necessary to satisfy constraints
