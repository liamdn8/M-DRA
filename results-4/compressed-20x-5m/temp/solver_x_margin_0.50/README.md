...
| **Optimal Value** | 129.00000000000003 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 129.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 19
...
- **Solution Quality:** 129 relocations needed
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-4/compressed-20x-5m/temp/solver_x_margin_0.50
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_x_margin_0.50`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 129 job relocations were necessary to satisfy constraints
