...
python3 main.py \
  ...
  --margin 1.0 \
  --out results-4/compressed-20x-5m/temp/solver_x_margin_1.00
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_x_margin_1.00`
