...
### Performance Metrics
- **Avg Time per Job:** 41.730 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-4/compressed-20x-5m/temp/solver_y_margin_0.75
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_y_margin_0.75`
