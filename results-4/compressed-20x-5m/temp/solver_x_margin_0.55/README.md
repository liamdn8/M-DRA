...
| **Optimal Value** | 105.99999999999999 |
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-4/compressed-20x-5m/temp/solver_x_margin_0.55
```
...
- **Output Directory:** `results-4/compressed-20x-5m/temp/solver_x_margin_0.55`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 106 job relocations were necessary to satisfy constraints
