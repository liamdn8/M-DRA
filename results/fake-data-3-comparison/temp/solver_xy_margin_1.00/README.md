...
python3 main.py \
  ...
  --margin 1.0 \
  --out results/fake-data-3-comparison/temp/solver_xy_margin_1.00
```
...
- **Output Directory:** `results/fake-data-3-comparison/temp/solver_xy_margin_1.00`
