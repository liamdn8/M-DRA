...
python3 main.py \
  ...
  --margin 0.65 \
  --out results/fake-data-3-comparison/temp/solver_y_margin_0.65
```
...
- **Output Directory:** `results/fake-data-3-comparison/temp/solver_y_margin_0.65`
