...
### Performance Metrics
- **Avg Time per Job:** 0.465 seconds
...
python3 main.py \
  ...
  --margin 0.9 \
  --out results/fake-data-3-comparison/temp/solver_xy_margin_0.90
```
...
- **Output Directory:** `results/fake-data-3-comparison/temp/solver_xy_margin_0.90`
