...
### Performance Metrics
- **Avg Time per Job:** 0.235 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results/fake-data-3-comparison/temp/solver_x_margin_0.95
```
...
- **Output Directory:** `results/fake-data-3-comparison/temp/solver_x_margin_0.95`
