...
python3 main.py \
  ...
  --margin 0.8 \
  --out results/fake-data-3-comparison/temp/solver_x_margin_0.80
```
...
- Job 3 assigned to Cluster 1 (default: 2), relocation cost: 2
...
- **Output Directory:** `results/fake-data-3-comparison/temp/solver_x_margin_0.80`
