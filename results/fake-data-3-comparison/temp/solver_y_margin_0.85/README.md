...
### Performance Metrics
- **Avg Time per Job:** 5.841 seconds
...
python3 main.py \
  ...
  --margin 0.85 \
  --out results/fake-data-3-comparison/temp/solver_y_margin_0.85
```
...
- **Output Directory:** `results/fake-data-3-comparison/temp/solver_y_margin_0.85`
