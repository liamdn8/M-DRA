...
### Performance Metrics
- **Avg Time per Job:** 0.458 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results/medium-comparison/temp/solver_xy_margin_0.95
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_xy_margin_0.95`
