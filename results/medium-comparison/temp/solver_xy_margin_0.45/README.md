...
python3 main.py \
  ...
  --margin 0.45 \
  --out results/medium-comparison/temp/solver_xy_margin_0.45
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_xy_margin_0.45`
