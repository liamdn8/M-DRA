...
python3 main.py \
  ...
  --margin 0.5 \
  --out results/medium-comparison/temp/solver_xy_margin_0.50
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_xy_margin_0.50`
