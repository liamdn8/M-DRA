...
### Performance Metrics
- **Avg Time per Job:** 0.502 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results/medium-comparison/temp/solver_xy_margin_1.00
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_xy_margin_1.00`
