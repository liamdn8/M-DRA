...
python3 main.py \
  ...
  --margin 0.85 \
  --out results/medium-comparison/temp/solver_xy_margin_0.85
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_xy_margin_0.85`
