...
python3 main.py \
  ...
  --margin 0.75 \
  --out results/medium-comparison/temp/solver_y_margin_0.75
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_y_margin_0.75`
