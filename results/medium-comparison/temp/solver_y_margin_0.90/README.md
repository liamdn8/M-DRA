...
### Performance Metrics
- **Avg Time per Job:** 18.662 seconds
...
python3 main.py \
  ...
  --margin 0.9 \
  --out results/medium-comparison/temp/solver_y_margin_0.90
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_y_margin_0.90`
