...
python3 main.py \
  ...
  --margin 0.85 \
  --out results/medium-comparison/temp/solver_x_margin_0.85
```
...
- Job 0 assigned to Cluster 3 (default: 0), relocation cost: 2
...
- **Output Directory:** `results/medium-comparison/temp/solver_x_margin_0.85`
