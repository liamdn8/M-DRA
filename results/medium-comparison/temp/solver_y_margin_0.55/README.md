...
python3 main.py \
  ...
  --margin 0.55 \
  --out results/medium-comparison/temp/solver_y_margin_0.55
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_y_margin_0.55`
