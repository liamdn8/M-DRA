...
python3 main.py \
  ...
  --margin 0.6 \
  --out results/medium-comparison/temp/solver_x_margin_0.60
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_x_margin_0.60`
