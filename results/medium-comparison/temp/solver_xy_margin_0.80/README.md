...
python3 main.py \
  ...
  --margin 0.8 \
  --out results/medium-comparison/temp/solver_xy_margin_0.80
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_xy_margin_0.80`
