...
python3 main.py \
  ...
  --margin 0.55 \
  --out results/medium-comparison/temp/solver_x_margin_0.55
```
...
- Job 4 assigned to Cluster 3 (default: 0), relocation cost: 5
...
- **Output Directory:** `results/medium-comparison/temp/solver_x_margin_0.55`
