...
### Performance Metrics
- **Avg Time per Job:** 32.863 seconds
...
python3 main.py \
  ...
  --margin 0.7 \
  --out results/medium-comparison/temp/solver_y_margin_0.70
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_y_margin_0.70`
