...
python3 main.py \
  ...
  --margin 0.65 \
  --out results/medium-comparison/temp/solver_xy_margin_0.65
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_xy_margin_0.65`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 31 job relocations were necessary to satisfy constraints
