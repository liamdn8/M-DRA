...
### Performance Metrics
- **Avg Time per Job:** 18.904 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results/medium-comparison/temp/solver_y_margin_0.95
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_y_margin_0.95`
