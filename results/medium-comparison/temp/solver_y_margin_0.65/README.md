...
### Performance Metrics
- **Avg Time per Job:** 29.985 seconds
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results/medium-comparison/temp/solver_y_margin_0.65
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_y_margin_0.65`
