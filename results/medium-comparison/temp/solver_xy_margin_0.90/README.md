...
python3 main.py \
  ...
  --margin 0.9 \
  --out results/medium-comparison/temp/solver_xy_margin_0.90
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_xy_margin_0.90`
