...
python3 main.py \
  ...
  --margin 1.0 \
  --out results/medium-comparison/temp/solver_x_margin_1.00
```
...
- **Output Directory:** `results/medium-comparison/temp/solver_x_margin_1.00`
