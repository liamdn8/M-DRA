...
### Performance Metrics
- **Avg Time per Job:** 0.137 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results/small-sample-comparison/temp/solver_x_margin_0.80
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_x_margin_0.80`
