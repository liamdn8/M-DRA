...
### Performance Metrics
- **Avg Time per Job:** 44.000 seconds
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results/small-sample-comparison/temp/solver_y_margin_0.55
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_y_margin_0.55`
