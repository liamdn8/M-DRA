...
python3 main.py \
  ...
  --margin 0.85 \
  --out results/small-sample-comparison/temp/solver_xy_margin_0.85
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_xy_margin_0.85`
