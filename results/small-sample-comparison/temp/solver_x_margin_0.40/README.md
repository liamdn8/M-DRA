...
- **Total Relocations:** 36.0
- **Jobs Assigned:** 40
- **Jobs Relocated:** 6
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.139 seconds
- **Solution Quality:** 36 relocations needed
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results/small-sample-comparison/temp/solver_x_margin_0.40
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_x_margin_0.40`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 36 job relocations were necessary to satisfy constraints
