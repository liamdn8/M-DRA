...
### Performance Metrics
- **Avg Time per Job:** 0.142 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results/small-sample-comparison/temp/solver_x_margin_0.95
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_x_margin_0.95`
