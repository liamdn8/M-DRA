...
### Performance Metrics
- **Avg Time per Job:** 14.789 seconds
...
python3 main.py \
  ...
  --margin 0.9 \
  --out results/small-sample-comparison/temp/solver_y_margin_0.90
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_y_margin_0.90`
