...
### Performance Metrics
- **Avg Time per Job:** 16.534 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results/small-sample-comparison/temp/solver_y_margin_0.75
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_y_margin_0.75`
