...
python3 main.py \
  ...
  --margin 0.4 \
  --out results/small-sample-comparison/temp/solver_xy_margin_0.40
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_xy_margin_0.40`
