...
python3 main.py \
  ...
  --margin 0.45 \
  --out results/small-sample-comparison/temp/solver_xy_margin_0.45
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_xy_margin_0.45`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 29 job relocations were necessary to satisfy constraints
