...
### Performance Metrics
- **Avg Time per Job:** 14.484 seconds
...
python3 main.py \
  ...
  --margin 0.85 \
  --out results/small-sample-comparison/temp/solver_y_margin_0.85
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_y_margin_0.85`
