...
python3 main.py \
  ...
  --margin 0.35 \
  --out results/small-sample-comparison/temp/solver_xy_margin_0.35
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_xy_margin_0.35`
