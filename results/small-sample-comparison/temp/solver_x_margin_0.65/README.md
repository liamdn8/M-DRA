...
### Performance Metrics
- **Avg Time per Job:** 0.140 seconds
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results/small-sample-comparison/temp/solver_x_margin_0.65
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_x_margin_0.65`
