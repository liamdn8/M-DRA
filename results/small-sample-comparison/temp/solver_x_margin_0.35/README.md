...
python3 main.py \
  ...
  --margin 0.35 \
  --out results/small-sample-comparison/temp/solver_x_margin_0.35
```
...
- Job 26 assigned to Cluster 2 (default: 0), relocation cost: 6
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_x_margin_0.35`
