...
python3 main.py \
  ...
  --margin 0.55 \
  --out results/small-sample-comparison/temp/solver_x_margin_0.55
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_x_margin_0.55`
