...
python3 main.py \
  ...
  --margin 0.65 \
  --out results/small-sample-comparison/temp/solver_y_margin_0.65
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_y_margin_0.65`
