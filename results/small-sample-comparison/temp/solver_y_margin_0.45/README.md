...
python3 main.py \
  ...
  --margin 0.45 \
  --out results/small-sample-comparison/temp/solver_y_margin_0.45
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_y_margin_0.45`
