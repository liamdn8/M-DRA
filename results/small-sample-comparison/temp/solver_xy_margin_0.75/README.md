...
### Performance Metrics
- **Avg Time per Job:** 0.474 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results/small-sample-comparison/temp/solver_xy_margin_0.75
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_xy_margin_0.75`
