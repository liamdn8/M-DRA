...
- **Solution Quality:** 6 relocations needed
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results/small-sample-comparison/temp/solver_xy_margin_1.00
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_xy_margin_1.00`
