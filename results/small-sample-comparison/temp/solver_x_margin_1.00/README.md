...
### Performance Metrics
- **Avg Time per Job:** 0.151 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results/small-sample-comparison/temp/solver_x_margin_1.00
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_x_margin_1.00`
