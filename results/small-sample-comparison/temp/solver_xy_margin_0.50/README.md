...
### Performance Metrics
- **Avg Time per Job:** 0.472 seconds
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results/small-sample-comparison/temp/solver_xy_margin_0.50
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_xy_margin_0.50`
