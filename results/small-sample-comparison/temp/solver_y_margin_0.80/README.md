...
### Performance Metrics
- **Avg Time per Job:** 14.021 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results/small-sample-comparison/temp/solver_y_margin_0.80
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_y_margin_0.80`
