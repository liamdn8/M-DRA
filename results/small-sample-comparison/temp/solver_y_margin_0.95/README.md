...
### Performance Metrics
- **Avg Time per Job:** 14.476 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results/small-sample-comparison/temp/solver_y_margin_0.95
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_y_margin_0.95`
