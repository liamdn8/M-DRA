...
python3 main.py \
  ...
  --margin 0.6 \
  --out results/small-sample-comparison/temp/solver_x_margin_0.60
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_x_margin_0.60`
