...
python3 main.py \
  ...
  --margin 0.5 \
  --out results/small-sample-comparison/temp/solver_y_margin_0.50
```
...
- **Output Directory:** `results/small-sample-comparison/temp/solver_y_margin_0.50`
