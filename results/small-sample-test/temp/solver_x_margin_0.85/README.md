...
### Performance Metrics
- **Avg Time per Job:** 0.123 seconds
...
python3 main.py \
  ...
  --margin 0.85 \
  --out results/small-sample-test/temp/solver_x_margin_0.85
```
...
- **Output Directory:** `results/small-sample-test/temp/solver_x_margin_0.85`
