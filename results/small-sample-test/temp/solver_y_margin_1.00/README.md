...
### Performance Metrics
- **Avg Time per Job:** 25.717 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results/small-sample-test/temp/solver_y_margin_1.00
```
...
- **Output Directory:** `results/small-sample-test/temp/solver_y_margin_1.00`
