...
### Performance Metrics
- **Avg Time per Job:** 0.286 seconds
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results/small-sample-test/temp/solver_x_margin_0.65
```
...
- **Output Directory:** `results/small-sample-test/temp/solver_x_margin_0.65`
