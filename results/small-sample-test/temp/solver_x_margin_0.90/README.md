...
python3 main.py \
  ...
  --margin 0.9 \
  --out results/small-sample-test/temp/solver_x_margin_0.90
```
...
- **Output Directory:** `results/small-sample-test/temp/solver_x_margin_0.90`
