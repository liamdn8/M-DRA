...
### Performance Metrics
- **Avg Time per Job:** 3.573 seconds
...
python3 main.py \
  ...
  --margin 0.45 \
  --out results/fake-data-comparison/temp/solver_xy_margin_0.45
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_xy_margin_0.45`
