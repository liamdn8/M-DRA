...
python3 main.py \
  ...
  --margin 0.65 \
  --out results/fake-data-comparison/temp/solver_x_margin_0.65
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_x_margin_0.65`
