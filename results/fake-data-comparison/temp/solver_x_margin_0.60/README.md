...
python3 main.py \
  ...
  --margin 0.6 \
  --out results/fake-data-comparison/temp/solver_x_margin_0.60
```
...
- Job 5 assigned to Cluster 0 (default: 1), relocation cost: 2
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_x_margin_0.60`
