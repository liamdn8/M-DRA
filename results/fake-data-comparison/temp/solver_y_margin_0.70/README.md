...
### Performance Metrics
- **Avg Time per Job:** 13.212 seconds
...
python3 main.py \
  ...
  --margin 0.7 \
  --out results/fake-data-comparison/temp/solver_y_margin_0.70
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_y_margin_0.70`
