...
### Performance Metrics
- **Avg Time per Job:** 0.212 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results/fake-data-comparison/temp/solver_x_margin_0.75
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_x_margin_0.75`
