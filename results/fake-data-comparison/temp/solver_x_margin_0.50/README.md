...
python3 main.py \
  ...
  --margin 0.5 \
  --out results/fake-data-comparison/temp/solver_x_margin_0.50
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_x_margin_0.50`
