...
### Performance Metrics
- **Avg Time per Job:** 13.777 seconds
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results/fake-data-comparison/temp/solver_y_margin_0.65
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_y_margin_0.65`
