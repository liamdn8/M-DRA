...
### Performance Metrics
- **Avg Time per Job:** 0.565 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results/fake-data-comparison/temp/solver_xy_margin_1.00
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_xy_margin_1.00`
