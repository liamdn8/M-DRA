...
### Performance Metrics
- **Avg Time per Job:** 0.206 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results/fake-data-comparison/temp/solver_x_margin_0.80
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_x_margin_0.80`
