...
### Performance Metrics
- **Avg Time per Job:** 14.751 seconds
...
python3 main.py \
  ...
  --margin 0.6 \
  --out results/fake-data-comparison/temp/solver_y_margin_0.60
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_y_margin_0.60`
