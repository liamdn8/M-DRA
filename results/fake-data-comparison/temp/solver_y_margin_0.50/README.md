...
### Performance Metrics
- **Avg Time per Job:** 17.239 seconds
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results/fake-data-comparison/temp/solver_y_margin_0.50
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_y_margin_0.50`
