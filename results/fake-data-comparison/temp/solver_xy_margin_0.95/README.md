...
### Performance Metrics
- **Avg Time per Job:** 0.610 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results/fake-data-comparison/temp/solver_xy_margin_0.95
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_xy_margin_0.95`
