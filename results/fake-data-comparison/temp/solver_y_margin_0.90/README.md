...
### Performance Metrics
- **Avg Time per Job:** 13.417 seconds
...
python3 main.py \
  ...
  --margin 0.9 \
  --out results/fake-data-comparison/temp/solver_y_margin_0.90
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_y_margin_0.90`
