...
### Performance Metrics
- **Avg Time per Job:** 0.205 seconds
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results/fake-data-comparison/temp/solver_x_margin_0.40
```
...
- Job 0 assigned to Cluster 3 (default: 0), relocation cost: 1
- Job 1 assigned to Cluster 4 (default: 4), relocation cost: 0
- Job 2 assigned to Cluster 1 (default: 5), relocation cost: 1
- Job 3 assigned to Cluster 3 (default: 2), relocation cost: 3
- Job 4 assigned to Cluster 2 (default: 0), relocation cost: 1
...
- Job 22 assigned to Cluster 4 (default: 1), relocation cost: 1
- Job 23 assigned to Cluster 5 (default: 5), relocation cost: 0
- Job 24 assigned to Cluster 2 (default: 2), relocation cost: 0
- Job 25 assigned to Cluster 0 (default: 3), relocation cost: 1
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_x_margin_0.40`
