...
python3 main.py \
  ...
  --margin 1.0 \
  --out results/fake-data-comparison/temp/solver_x_margin_1.00
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_x_margin_1.00`
