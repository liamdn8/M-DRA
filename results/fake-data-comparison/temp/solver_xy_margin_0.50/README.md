...
### Performance Metrics
- **Avg Time per Job:** 0.604 seconds
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results/fake-data-comparison/temp/solver_xy_margin_0.50
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_xy_margin_0.50`
