...
### Performance Metrics
- **Avg Time per Job:** 13.198 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results/fake-data-comparison/temp/solver_y_margin_0.80
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_y_margin_0.80`
