...
### Performance Metrics
- **Avg Time per Job:** 0.645 seconds
...
python3 main.py \
  ...
  --margin 0.6 \
  --out results/fake-data-comparison/temp/solver_xy_margin_0.60
```
...
- **Output Directory:** `results/fake-data-comparison/temp/solver_xy_margin_0.60`
