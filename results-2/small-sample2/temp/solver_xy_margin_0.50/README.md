...
- **Solution Quality:** 17 relocations needed
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-2/small-sample2/temp/solver_xy_margin_0.50
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_xy_margin_0.50`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 17 job relocations were necessary to satisfy constraints
