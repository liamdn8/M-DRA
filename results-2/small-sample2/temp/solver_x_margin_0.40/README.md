...
- **Total Relocations:** 28.0
- **Jobs Assigned:** 13
- **Jobs Relocated:** 5
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.221 seconds
- **Solution Quality:** 28 relocations needed
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/small-sample2/temp/solver_x_margin_0.40
```
...
- Job 7 assigned to Cluster 2 (default: 1), relocation cost: 7
...
- **Output Directory:** `results-2/small-sample2/temp/solver_x_margin_0.40`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 28 job relocations were necessary to satisfy constraints
