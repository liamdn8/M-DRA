...
### Performance Metrics
- **Avg Time per Job:** 3.468 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results-2/small-sample2/temp/solver_y_margin_0.95
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_y_margin_0.95`
