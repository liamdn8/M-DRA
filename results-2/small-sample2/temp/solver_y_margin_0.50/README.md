...
### Performance Metrics
- **Avg Time per Job:** 3.556 seconds
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-2/small-sample2/temp/solver_y_margin_0.50
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_y_margin_0.50`
