...
### Performance Metrics
- **Avg Time per Job:** 3.507 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-2/small-sample2/temp/solver_y_margin_0.75
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_y_margin_0.75`
