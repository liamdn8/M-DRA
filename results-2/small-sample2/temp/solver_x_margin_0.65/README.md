...
### Performance Metrics
- **Avg Time per Job:** 0.216 seconds
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results-2/small-sample2/temp/solver_x_margin_0.65
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_x_margin_0.65`
