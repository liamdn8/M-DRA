...
### Performance Metrics
- **Avg Time per Job:** 0.230 seconds
...
python3 main.py \
  ...
  --margin 0.7 \
  --out results-2/small-sample2/temp/solver_x_margin_0.70
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_x_margin_0.70`
