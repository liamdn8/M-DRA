...
### Performance Metrics
- **Avg Time per Job:** 0.312 seconds
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-2/small-sample2/temp/solver_xy_margin_0.55
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_xy_margin_0.55`
