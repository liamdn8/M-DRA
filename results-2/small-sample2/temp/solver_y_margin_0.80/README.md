...
### Performance Metrics
- **Avg Time per Job:** 3.518 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results-2/small-sample2/temp/solver_y_margin_0.80
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_y_margin_0.80`
