...
| **Optimal Value** | 25.000000000000004 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 25.0
- **Jobs Assigned:** 13
- **Jobs Relocated:** 3
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.316 seconds
- **Solution Quality:** 25 relocations needed
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/small-sample2/temp/solver_xy_margin_0.40
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_xy_margin_0.40`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 25 job relocations were necessary to satisfy constraints
