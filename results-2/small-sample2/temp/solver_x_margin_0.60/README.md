...
- **Solution Quality:** 11 relocations needed
...
python3 main.py \
  ...
  --margin 0.6 \
  --out results-2/small-sample2/temp/solver_x_margin_0.60
```
...
- Job 2 assigned to Cluster 2 (default: 0), relocation cost: 5
...
- **Output Directory:** `results-2/small-sample2/temp/solver_x_margin_0.60`
