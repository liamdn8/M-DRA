...
- **Total Relocations:** 3.0
- **Jobs Assigned:** 13
- **Jobs Relocated:** 1
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.317 seconds
- **Solution Quality:** 3 relocations needed
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results-2/small-sample2/temp/solver_xy_margin_0.80
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_xy_margin_0.80`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 3 job relocations were necessary to satisfy constraints
