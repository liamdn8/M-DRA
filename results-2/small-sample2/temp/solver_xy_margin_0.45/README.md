...
- **Total Relocations:** 18.0
- **Jobs Assigned:** 13
- **Jobs Relocated:** 3
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.308 seconds
- **Solution Quality:** 18 relocations needed
...
python3 main.py \
  ...
  --margin 0.45 \
  --out results-2/small-sample2/temp/solver_xy_margin_0.45
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_xy_margin_0.45`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 18 job relocations were necessary to satisfy constraints
