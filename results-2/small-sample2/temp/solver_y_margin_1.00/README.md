...
### Performance Metrics
- **Avg Time per Job:** 3.534 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results-2/small-sample2/temp/solver_y_margin_1.00
```
...
- **Output Directory:** `results-2/small-sample2/temp/solver_y_margin_1.00`
