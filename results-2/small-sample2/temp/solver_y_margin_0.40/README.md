...
- **Total Relocations:** 35.0
- **Jobs Assigned:** 0
- **Jobs Relocated:** 0
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 3.590 seconds
- **Solution Quality:** 35 relocations needed
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/small-sample2/temp/solver_y_margin_0.40
```
...
- Node 4 assigned to Cluster 0 at time 2
...
- **Output Directory:** `results-2/small-sample2/temp/solver_y_margin_0.40`
- **Solver Mode:** Y (Node Allocation)

## 💡 Notes

- 35 job relocations were necessary to satisfy constraints
