...
### Performance Metrics
- **Avg Time per Job:** 0.533 seconds
...
python3 main.py \
  ...
  --margin 0.35 \
  --out results-2/small-sample/temp/solver_xy_margin_0.35
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_xy_margin_0.35`
