...
### Performance Metrics
- **Avg Time per Job:** 15.480 seconds
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/small-sample/temp/solver_y_margin_0.40
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_y_margin_0.40`
