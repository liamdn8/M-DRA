...
### Performance Metrics
- **Avg Time per Job:** 0.482 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results-2/small-sample/temp/solver_xy_margin_0.95
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_xy_margin_0.95`
