...
- **Total Relocations:** 70.0
- **Jobs Assigned:** 0
- **Jobs Relocated:** 0
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 14.179 seconds
- **Solution Quality:** 70 relocations needed
...
python3 main.py \
  ...
  --margin 0.35 \
  --out results-2/small-sample/temp/solver_y_margin_0.35
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_y_margin_0.35`
- **Solver Mode:** Y (Node Allocation)

## 💡 Notes

- 70 job relocations were necessary to satisfy constraints
