...
### Performance Metrics
- **Avg Time per Job:** 0.145 seconds
...
python3 main.py \
  ...
  --margin 0.9 \
  --out results-2/small-sample/temp/solver_x_margin_0.90
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_x_margin_0.90`
