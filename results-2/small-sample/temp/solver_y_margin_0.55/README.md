...
### Performance Metrics
- **Avg Time per Job:** 45.965 seconds
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-2/small-sample/temp/solver_y_margin_0.55
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_y_margin_0.55`
