...
### Performance Metrics
- **Avg Time per Job:** 34.093 seconds
...
python3 main.py \
  ...
  --margin 0.7 \
  --out results-2/small-sample/temp/solver_y_margin_0.70
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_y_margin_0.70`
