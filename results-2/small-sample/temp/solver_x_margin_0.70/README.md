...
python3 main.py \
  ...
  --margin 0.7 \
  --out results-2/small-sample/temp/solver_x_margin_0.70
```
...
- Job 11 assigned to Cluster 1 (default: 0), relocation cost: 5
...
- **Output Directory:** `results-2/small-sample/temp/solver_x_margin_0.70`
