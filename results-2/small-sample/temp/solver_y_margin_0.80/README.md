...
### Performance Metrics
- **Avg Time per Job:** 14.451 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results-2/small-sample/temp/solver_y_margin_0.80
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_y_margin_0.80`
