...
### Performance Metrics
- **Avg Time per Job:** 14.702 seconds
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-2/small-sample/temp/solver_y_margin_0.50
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_y_margin_0.50`
