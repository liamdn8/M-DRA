...
### Performance Metrics
- **Avg Time per Job:** 0.141 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-2/small-sample/temp/solver_x_margin_0.75
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_x_margin_0.75`
