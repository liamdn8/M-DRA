...
### Performance Metrics
- **Avg Time per Job:** 0.527 seconds
...
python3 main.py \
  ...
  --margin 0.45 \
  --out results-2/small-sample/temp/solver_xy_margin_0.45
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_xy_margin_0.45`
