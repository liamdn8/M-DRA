...
### Performance Metrics
- **Avg Time per Job:** 0.147 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results-2/small-sample/temp/solver_x_margin_1.00
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_x_margin_1.00`
