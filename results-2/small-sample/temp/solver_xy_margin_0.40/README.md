...
### Performance Metrics
- **Avg Time per Job:** 0.505 seconds
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/small-sample/temp/solver_xy_margin_0.40
```
...
- Job 29 assigned to Cluster 1...(truncated)
```
...
- **Output Directory:** `results-2/small-sample/temp/solver_xy_margin_0.40`
