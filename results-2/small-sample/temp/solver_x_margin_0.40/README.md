...
### Performance Metrics
- **Avg Time per Job:** 0.154 seconds
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/small-sample/temp/solver_x_margin_0.40
```
...
- Job 19 assigned to Cluster 1 (default: 0), relocation cost: 5
...
- **Output Directory:** `results-2/small-sample/temp/solver_x_margin_0.40`
