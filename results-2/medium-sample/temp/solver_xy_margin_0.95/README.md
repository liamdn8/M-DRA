...
### Performance Metrics
- **Avg Time per Job:** 0.493 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results-2/medium-sample/temp/solver_xy_margin_0.95
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_xy_margin_0.95`
