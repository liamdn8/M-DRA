...
### Performance Metrics
- **Avg Time per Job:** 0.576 seconds
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-2/medium-sample/temp/solver_xy_margin_0.50
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_xy_margin_0.50`
