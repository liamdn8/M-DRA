...
### Performance Metrics
- **Avg Time per Job:** 0.498 seconds
...
python3 main.py \
  ...
  --margin 0.9 \
  --out results-2/medium-sample/temp/solver_xy_margin_0.90
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_xy_margin_0.90`
