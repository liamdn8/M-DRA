...
### Performance Metrics
- **Avg Time per Job:** 20.798 seconds
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-2/medium-sample/temp/solver_y_margin_0.55
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_y_margin_0.55`
