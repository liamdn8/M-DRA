...
### Performance Metrics
- **Avg Time per Job:** 0.509 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results-2/medium-sample/temp/solver_xy_margin_1.00
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_xy_margin_1.00`
