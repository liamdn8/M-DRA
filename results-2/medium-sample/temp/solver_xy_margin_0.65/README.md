...
| **Optimal Value** | 28.000000000000018 |
...
### Performance Metrics
- **Avg Time per Job:** 0.537 seconds
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results-2/medium-sample/temp/solver_xy_margin_0.65
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_xy_margin_0.65`
