...
### Performance Metrics
- **Avg Time per Job:** 20.307 seconds
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results-2/medium-sample/temp/solver_y_margin_0.65
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_y_margin_0.65`
