...
- **Solution Quality:** 43 relocations needed
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-2/medium-sample/temp/solver_x_margin_0.50
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_x_margin_0.50`
