...
### Performance Metrics
- **Avg Time per Job:** 20.001 seconds
...
python3 main.py \
  ...
  --margin 0.95 \
  --out results-2/medium-sample/temp/solver_y_margin_0.95
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_y_margin_0.95`
