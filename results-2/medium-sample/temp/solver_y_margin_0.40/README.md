...
### Performance Metrics
- **Avg Time per Job:** 20.351 seconds
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/medium-sample/temp/solver_y_margin_0.40
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_y_margin_0.40`
