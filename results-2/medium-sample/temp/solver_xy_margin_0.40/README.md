...
- **Total Relocations:** 63.0
- **Jobs Assigned:** 61
- **Jobs Relocated:** 3
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.555 seconds
- **Solution Quality:** 63 relocations needed
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/medium-sample/temp/solver_xy_margin_0.40
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_xy_margin_0.40`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 63 job relocations were necessary to satisfy constraints
