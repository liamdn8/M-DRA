...
### Performance Metrics
- **Avg Time per Job:** 19.824 seconds
...
python3 main.py \
  ...
  --margin 0.45 \
  --out results-2/medium-sample/temp/solver_y_margin_0.45
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_y_margin_0.45`
