...
- **Total Relocations:** 48.0
- **Jobs Assigned:** 61
- **Jobs Relocated:** 8
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.158 seconds
- **Solution Quality:** 48 relocations needed
...
python3 main.py \
  ...
  --margin 0.45 \
  --out results-2/medium-sample/temp/solver_x_margin_0.45
```
...
- Job 12 assigned to Cluster 1 (default: 0), relocation cost: 4
...
- Job 21 assigned to Cluster 1 (default: 0), relocation cost: 5
...
- **Output Directory:** `results-2/medium-sample/temp/solver_x_margin_0.45`
