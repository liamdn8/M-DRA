...
### Performance Metrics
- **Avg Time per Job:** 20.071 seconds
...
python3 main.py \
  ...
  --margin 0.7 \
  --out results-2/medium-sample/temp/solver_y_margin_0.70
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_y_margin_0.70`
