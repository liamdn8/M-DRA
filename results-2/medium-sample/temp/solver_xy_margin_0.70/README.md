...
- **Total Relocations:** 23.0
- **Jobs Assigned:** 61
- **Jobs Relocated:** 3
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.531 seconds
- **Solution Quality:** 23 relocations needed
...
python3 main.py \
  ...
  --margin 0.7 \
  --out results-2/medium-sample/temp/solver_xy_margin_0.70
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_xy_margin_0.70`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 23 job relocations were necessary to satisfy constraints
