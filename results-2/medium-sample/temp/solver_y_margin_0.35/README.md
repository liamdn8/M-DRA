...
### Performance Metrics
- **Avg Time per Job:** 20.056 seconds
...
python3 main.py \
  ...
  --margin 0.35 \
  --out results-2/medium-sample/temp/solver_y_margin_0.35
```
...
- **Output Directory:** `results-2/medium-sample/temp/solver_y_margin_0.35`
