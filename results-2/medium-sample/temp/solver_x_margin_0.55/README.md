...
- **Total Relocations:** 39.0
- **Jobs Assigned:** 61
- **Jobs Relocated:** 7
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.159 seconds
- **Solution Quality:** 39 relocations needed
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-2/medium-sample/temp/solver_x_margin_0.55
```
...
- Job 1 assigned to Cluster 1 (default: 0), relocation cost: 2
...
- Job 20 assigned to Cluster 1 (default: 0), relocation cost: 5
...
- **Output Directory:** `results-2/medium-sample/temp/solver_x_margin_0.55`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 39 job relocations were necessary to satisfy constraints
