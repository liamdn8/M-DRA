...
python3 main.py \
  ...
  --margin 0.45 \
  --out results-2/large-sample/temp/solver_x_margin_0.45
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_x_margin_0.45`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 81 job relocations were necessary to satisfy constraints
