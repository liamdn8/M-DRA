...
- **Total Relocations:** 44.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 3
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.841 seconds
- **Solution Quality:** 44 relocations needed
...
python3 main.py \
  ...
  --margin 0.45 \
  --out results-2/large-sample/temp/solver_xy_margin_0.45
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_xy_margin_0.45`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 44 job relocations were necessary to satisfy constraints
