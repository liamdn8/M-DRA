...
### Performance Metrics
- **Avg Time per Job:** 67.568 seconds
...
python3 main.py \
  ...
  --margin 0.6 \
  --out results-2/large-sample/temp/solver_y_margin_0.60
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_0.60`
