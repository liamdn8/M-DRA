...
| **Status** | ✅ optimal |
| **Return Code** | 0 |
| **Execution Time** | 64.71 seconds |
| **Optimal Value** | 61.0 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 61.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 8
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 0.310 seconds
- **Solution Quality:** 61 relocations needed
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-2/large-sample/temp/solver_x_margin_0.50
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_x_margin_0.50`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 61 job relocations were necessary to satisfy constraints
