...
### Performance Metrics
- **Avg Time per Job:** 66.772 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results-2/large-sample/temp/solver_y_margin_1.00
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_1.00`
