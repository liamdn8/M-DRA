...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-2/large-sample/temp/solver_x_margin_0.55
```
...
- Job 7 assigned to Cluster 3 (default: 0), relocation cost: 2
...
- **Output Directory:** `results-2/large-sample/temp/solver_x_margin_0.55`
