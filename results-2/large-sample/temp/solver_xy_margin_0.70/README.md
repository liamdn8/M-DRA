...
### Performance Metrics
- **Avg Time per Job:** 0.819 seconds
...
python3 main.py \
  ...
  --margin 0.7 \
  --out results-2/large-sample/temp/solver_xy_margin_0.70
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_xy_margin_0.70`
