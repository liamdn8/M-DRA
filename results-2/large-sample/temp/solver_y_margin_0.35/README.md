...
### Performance Metrics
- **Avg Time per Job:** 71.219 seconds
- **Solution Quality:** 160 relocations needed
...
python3 main.py \
  ...
  --margin 0.35 \
  --out results-2/large-sample/temp/solver_y_margin_0.35
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_0.35`
- **Solver Mode:** Y (Node Allocation)

## 💡 Notes

- 160 job relocations were necessary to satisfy constraints
