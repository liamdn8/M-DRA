...
| **Optimal Value** | 20.00000000000009 |
...
### Performance Metrics
- **Avg Time per Job:** 64.767 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-2/large-sample/temp/solver_y_margin_0.75
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_0.75`
