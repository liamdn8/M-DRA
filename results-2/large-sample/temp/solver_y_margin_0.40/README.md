...
- **Total Relocations:** 120.0
- **Jobs Assigned:** 0
- **Jobs Relocated:** 0
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 69.571 seconds
- **Solution Quality:** 120 relocations needed
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/large-sample/temp/solver_y_margin_0.40
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_0.40`
- **Solver Mode:** Y (Node Allocation)

## 💡 Notes

- 120 job relocations were necessary to satisfy constraints
