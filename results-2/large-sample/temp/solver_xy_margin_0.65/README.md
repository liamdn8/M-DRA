...
### Performance Metrics
- **Avg Time per Job:** 0.850 seconds
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results-2/large-sample/temp/solver_xy_margin_0.65
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_xy_margin_0.65`
