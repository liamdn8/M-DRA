...
- **Total Relocations:** 80.0
- **Jobs Assigned:** 0
- **Jobs Relocated:** 0
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 75.403 seconds
- **Solution Quality:** 80 relocations needed
...
python3 main.py \
  ...
  --margin 0.5 \
  --out results-2/large-sample/temp/solver_y_margin_0.50
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_0.50`
- **Solver Mode:** Y (Node Allocation)

## 💡 Notes

- 80 job relocations were necessary to satisfy constraints
