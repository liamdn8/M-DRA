...
### Performance Metrics
- **Avg Time per Job:** 67.092 seconds
...
python3 main.py \
  ...
  --margin 0.9 \
  --out results-2/large-sample/temp/solver_y_margin_0.90
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_0.90`
