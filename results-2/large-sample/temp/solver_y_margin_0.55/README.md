...
### Performance Metrics
- **Avg Time per Job:** 70.084 seconds
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-2/large-sample/temp/solver_y_margin_0.55
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_0.55`
