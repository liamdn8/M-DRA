...
- **Total Relocations:** 100.0
- **Jobs Assigned:** 0
- **Jobs Relocated:** 0
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 67.316 seconds
- **Solution Quality:** 100 relocations needed
...
python3 main.py \
  ...
  --margin 0.45 \
  --out results-2/large-sample/temp/solver_y_margin_0.45
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_0.45`
- **Solver Mode:** Y (Node Allocation)

## 💡 Notes

- 100 job relocations were necessary to satisfy constraints
