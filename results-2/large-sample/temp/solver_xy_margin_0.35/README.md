...
| **Status** | ✅ optimal |
| **Return Code** | 0 |
| **Execution Time** | 491.68 seconds |
| **Optimal Value** | 85.00000000000001 |
| **Feasibility** | ✅ Feasible |

## 🎯 Solution Summary

- **Total Relocations:** 85.0
- **Jobs Assigned:** 209
- **Jobs Relocated:** 8
- **Optimization Success:** ✅ Optimal solution found

### Performance Metrics
- **Avg Time per Job:** 2.353 seconds
- **Solution Quality:** 85 relocations needed
...
python3 main.py \
  ...
  --margin 0.35 \
  --out results-2/large-sample/temp/solver_xy_margin_0.35
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_xy_margin_0.35`
- **Solver Mode:** XY (Combined Optimization)

## 💡 Notes

- 85 job relocations were necessary to satisfy constraints
