...
| **Return Code** | 0 |
| **Execution Time** | 200.11 seconds |
| **Optimal Value** | 40.000000000000085 |
...
python3 main.py \
  ...
  --margin 0.55 \
  --out results-2/large-sample/temp/solver_xy_margin_0.55
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_xy_margin_0.55`
