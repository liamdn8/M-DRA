...
### Performance Metrics
- **Avg Time per Job:** 0.769 seconds
...
python3 main.py \
  ...
  --margin 0.8 \
  --out results-2/large-sample/temp/solver_xy_margin_0.80
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_xy_margin_0.80`
