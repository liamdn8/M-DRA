...
### Performance Metrics
- **Avg Time per Job:** 0.797 seconds
...
python3 main.py \
  ...
  --margin 0.85 \
  --out results-2/large-sample/temp/solver_xy_margin_0.85
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_xy_margin_0.85`
