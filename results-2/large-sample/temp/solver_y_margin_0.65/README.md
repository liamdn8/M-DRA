...
### Performance Metrics
- **Avg Time per Job:** 68.735 seconds
...
python3 main.py \
  ...
  --margin 0.65 \
  --out results-2/large-sample/temp/solver_y_margin_0.65
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_y_margin_0.65`
