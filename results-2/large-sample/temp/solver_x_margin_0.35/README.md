...
python3 main.py \
  ...
  --margin 0.35 \
  --out results-2/large-sample/temp/solver_x_margin_0.35
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_x_margin_0.35`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 163 job relocations were necessary to satisfy constraints
