...
| **Status** | ✅ optimal |
| **Return Code** | 0 |
| **Execution Time** | 177.20 seconds |
| **Optimal Value** | 60.00000000000005 |
...
### Performance Metrics
- **Avg Time per Job:** 0.848 seconds
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/large-sample/temp/solver_xy_margin_0.40
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_xy_margin_0.40`
