...
### Performance Metrics
- **Avg Time per Job:** 0.759 seconds
...
python3 main.py \
  ...
  --margin 0.75 \
  --out results-2/large-sample/temp/solver_xy_margin_0.75
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_xy_margin_0.75`
