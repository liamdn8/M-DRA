...
- **Solution Quality:** 116 relocations needed
...
python3 main.py \
  ...
  --margin 0.4 \
  --out results-2/large-sample/temp/solver_x_margin_0.40
```
...
- Job 9 assigned to Cluster 1 (default: 0), relocation cost: 3
...
- **Output Directory:** `results-2/large-sample/temp/solver_x_margin_0.40`
- **Solver Mode:** X (Job Allocation)

## 💡 Notes

- 116 job relocations were necessary to satisfy constraints
