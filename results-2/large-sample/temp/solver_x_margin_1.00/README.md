...
### Performance Metrics
- **Avg Time per Job:** 0.321 seconds
...
python3 main.py \
  ...
  --margin 1.0 \
  --out results-2/large-sample/temp/solver_x_margin_1.00
```
...
- **Output Directory:** `results-2/large-sample/temp/solver_x_margin_1.00`
